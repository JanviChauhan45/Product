...
<body class="horizontal-layout horizontal-menu  navbar-sticky footer-fixed  " data-open="hover"
  ...
  <div class="app-content content ">
    ...
    <div class="datatable-design mb-0 pt-1 bg-white resize_wrapper">
      <table id="category_table" class="table table-striped table-custom-hover nowrap  display " style="width: 100%;">
        <thead>
          <tr>
  ...
  <div class="modal fade text-left addmodal" data-keyboard="false" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
    <div class="modal-dialog modal-md modal-dialog-centered  modal-dialog-scrollable" role="document">
      ...
      <span aria-hidden="true">&times;</span>
                ...
                <input type="hidden" id="CategoryId">
                  <div class="row">
                    <div class="col-xl-12 col-lg-12 col-sm-12 mb-2">
                      <label class=" lable-align">Category Name</label>
                      <input type="text" id = "name" class="form-control fieldmandatory" placeholder="Enter Category Name" maxlength="50" oninput="this.value=this.value.replace(/[^a-zA-Z ]/g,'')">
                    </div>
                    <div class="col-xl-12 col-lg-12 col-sm-12 mb-1">
                      <label class="lable-align">Description</label>
                      <textarea class="form-control fieldmandatory textareasize" id="description" placeholder="Enter Description"  maxlength="255" oninput = "this.value=this.value.replace(/[^a-zA-Z0-9 ]/g,'')"></textarea>
			...
			<div class="col-xl-6 col-lg-6 col-sm-6 text-right colmspadding width50" >
              		<div class="form-check float-left" id="activeDiv">
                    ...
                    <div class="col-xl-6 col-lg-6 col-sm-6 text-right colmspadding">
                        <a href="javascript:void(0)" onclick="saveOrUpdateCategory()" class="btn btn-success  m-r-5"  id="toastr-success">
  ...
  <script src="assets/custom/js/category.js"></script>
</body>
<!-- END: Body-->
