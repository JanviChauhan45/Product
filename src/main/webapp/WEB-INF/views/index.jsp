                ...
                <form name="loginForm" class="m-t-5 loginforms">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group ">
                      ...
                      <input type="text" id="name" class="form-control" placeholder="Enter User Name" maxlength = "30" oninput="this.value=this.value.replace(/[^a-zA-Z0-9]/g,'')">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="input-group ">
                      ...
                      <input type="password" id="password" maxlength =  "20" class="form-control" placeholder="Enter Password">
                    </div>
                  </div>                 
                  <a class="btn btn-primary btn-block" onclick="login()" ><i class="fas fa-sign-out-alt m-r-5"></i>Login </a>
                  <a class="btn btn-success btn-block" href="signup" ><i class="fas fa-user-plus m-r-5"></i>Sign Up </a>
            </div>
                </form>
