...
<body class="horizontal-layout horizontal-menu  navbar-sticky footer-fixed  " data-open="hover"
                ...
                <form name="loginForm" class="m-t-5 loginforms">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group ">
                      ...
                      <input type="text" id="name" class="form-control" placeholder="Enter User Name" maxlength = 20 oninput="this.value=this.value.replace(/[^a-zA-Z ]/g,'')">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="input-group ">
                      ...
                      <input type="text" id="email" class="form-control" placeholder="Enter Email Id" maxlength = 60 oninput="this.value=this.value.replace(/[^a-zA-Z0-9@._-]/g,'')">
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group ">
                      ...
                      <input type="password" id="confirmPassword" class="form-control" placeholder="Enter Confirm Password">
                    </div>
                  </div>                 
                  <a class="btn btn-primary btn-block"  onclick="signup()" ><i class="fas fa-save m-r-5"></i>Save</a>

                  <a class="btn btn-danger btn-block" href="/" ><i class="fas fa-undo-alt m-r-5"></i>Cancel</a>
            </div>
                </form>
  ...
  <script src="assets/custom/plugins/bootstrap-select/bootstrap-select.js"></script>
    <script src = "assets/custom/js/signup.js"></script>
